      ...
      <v-card-text>
        ...
        >
            ...
            <v-tooltip top>
              <template v-slot:activator="{ on }">
                <v-icon
                  large
                  ripple
                  @click="$store.state.clickedSend=true;$store.state.conversionDialog=true;"
                  v-on="on"
                >
                  arrow_drop_down
                </v-icon>
          ...
          >
            ...
            >
              <v-col class="display-1 text--primary">
                <span>{{ $store.state.sendToken }}</span>
              </v-col>
            </v-row>
            <v-tooltip bottom>
              <template v-slot:activator="{ on }">
            ...
            >
              <v-col class="display-1 text--primary">
                <span>{{ $store.state.receiveToken }}</span>
              </v-col>
            </v-row>
          </v-card-text>
          <v-row no-gutters>
            ...
            <v-tooltip top>
              <template v-slot:activator="{ on }">
                <v-icon
                  large
                  ripple
                  @click="$store.state.clickedSend=false;$store.state.conversionDialog=true;"
                  v-on="on"
                >
                  arrow_drop_down
                </v-icon>
